...
import { IPC, type BatchRequest, type CatalogPayload, type DesktopApi, type PreviewPayload, type StudioCardPayload, type StudioExportPayload, type StudioGameExportPayload, type StudioGameExportRequest, type StudioMetadataRequest, type StudioPreviewPayload } from "../src/ipc-contract.ts";
